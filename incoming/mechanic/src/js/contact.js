...
function storeStatus() {
  ...
  if (dayOfWeek === "Saturday" || dayOfWeek === "Sunday") {
    outputTime = '<span class="closed text-danger fw-bold">Closed</span> on weekends. See you Monday. &#128578;';
  } else if (hours >= 9 && hours < 17) {
    outputTime = '<span class="open text-success fw-bold">Open</span> send me a WhatsApp.';
  } else {
    outputTime = '<span class="closed text-danger fw-bold">Closed</span> at the moment. Hours are 09:00 AM - 05:00 PM. &#128564;';
  }
...
if (contactForm) {
  ...
  contactForm.addEventListener("submit", function (event) {
    ...
    if (!validateForm()) {
      ...
      const receiveEmail = "saqib@saqibtech.com";
