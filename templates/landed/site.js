/*
	Landed (forgeified) site.js — consolidated in load order:
	jquery.min.js, jquery.scrolly.min.js, jquery.dropotron.min.js, jquery.scrollex.min.js, browser.min.js, breakpoints.min.js, util.js, main.js
	plus the FG1 lead-form handler and FG1 auxiliary form handlers.
*/
;
/* ---- jquery.min.js ---- */
...
/* ---- FG1 auxiliary forms (newsletter signup + appointment request) ----
   Both post through the same public site-form endpoint as the lead form, so they
   are live end-to-end; in demo mode they show the honest demo notice instead. */
(function () {
  function wire(id, buildPayload) {
  ...
  wire("newsletter-form", function (data) {
    return {
      projectId: window.FG1.projectId,
      formToken: window.FG1.formToken,
  ...
  wire("booking-form", function (data) {
    return {
      ...
      phone: data.get("phone") || "",
      email: "",
      message: "Appointment request from the website. Preferred time: " +
        (data.get("preferred_time") || "not specified") + "."
    };
  });
})();
