/*
	Phantom (forgeified) — consolidated site script.
	jquery.min.js + browser.min.js + breakpoints.min.js + util.js + main.js
	(Phantom by HTML5 UP — CC BY 3.0) followed by the FG1 form handlers.
*/
